...
<div id="wrapper">
    ...
    <?php
		//create a loop that writes a form that displays all of the products in the SESSION inventory array
			...
			// spelled error: $arryProductArray should be change to $aryProductArray
    ...
    <fieldset>
      ...
      <?php
            ...
            <div>
            	...
            	<b><?php echo $thisProduceItem->product_name; ?></b><br /> <!--  missed ";" -->
                Price: $<?php echo $thisProduceItem->product_price; ?><!--  missed ";" -->
